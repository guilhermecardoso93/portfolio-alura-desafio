    ...
    <main className=" flex flex-row justify-between py-32">
      <div className="flex flex-col gap-4">
        ...
        <ul className="flex flex-row gap-10">
          ...
          <li>
            <a href='https://www.instagram.com/guicardoso93/'className="flex flex-row cursor-pointer">
              Instragam
              <ArrowUpRight />
            </a>
          </li>
      ...
      <img src="https://github.com/guilhermecardoso93.png" alt="" className="w-auto p-auto rounded-full" />
    </main>
  );
}
