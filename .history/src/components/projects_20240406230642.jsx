      ...
      <div>
        <ul className="flex flex-row justify-center gap-10 items-center flex-wrap">
          {projectsRight.map((project, index) => {
            return (
              <li className="flex flex-row justify-between items-center gap-10">
                <img
                  src={project.img}
                  alt=""
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-5 mt-3">
                    <button className="w-[566px] max-w-[116px] h-[51px] text-[#2A7ae4] border-2 border-[#2A7ae4] rounded-sm">
