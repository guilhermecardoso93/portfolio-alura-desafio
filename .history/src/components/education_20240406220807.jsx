      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-col gap-3">
          <div className="bg-white rounded-sm h-[286px] w-[368px] flex items-center justify-center">
            <img src={oracle} alt="" className="w-[292px] h-[170px] p-1 rounded-sm" />
          </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="bg-white rounded-sm h-[286px] w-[368px] flex items-center justify-center">
            <img src={rocket} alt="" className="w-[292px] h-[170px] p-1 rounded-sm" />
          </div>
          <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-3">
          <div className="bg-white rounded-sm h-[286px] w-[368px] flex items-center justify-center">
            <img src={cna} alt="" className="w-[292px] h-[170px] p-1 rounded-sm" />
          </div>
          <div className="flex flex-col">
