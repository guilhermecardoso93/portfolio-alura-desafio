...
export function Contact() {
  ...
  return (
    <div className="w-full flex flex-row gap-10 my-0 mx-auto mb-10 px-20">
      ...
      <div className="flex-1  gap-10 px-4">
        ...
        <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6">
          ...
          />
          <button type="submit" className="w-[165px] h-[51px] bg-[#2A7ae4] border-2 text-white rounded-sm">
